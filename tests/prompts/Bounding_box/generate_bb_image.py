...
def generate_bb_image(bounding_box, s):
            ...
            for box in bb_string:
                ...
                file_path = f"tests/prompts/Bounding_box/scene{s}_{character}.png"  # Construct the file path
                try:
            ...
            final_image_path = f"tests/prompts/Bounding_box/scene{s}_bounding_box.png" 
